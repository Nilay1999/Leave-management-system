...
export const teams = [
  ...
  { name: 'Angular/React Team', description: 'Angular/React Team' },
  { name: 'Java Team', description: 'Java Team' },
  { name: 'Android Team', description: 'Android Team' },
  { name: 'UX & UI Team', description: 'UX & UI Team' },
  { name: 'QA Team', description: 'QA Team' },
  { name: 'PHP Team', description: 'PHP Team' },
  { name: 'IOS Team', description: 'IOS Team' },
];
...
export const roles = [
  ...
  { name: 'QA', description: 'Quality Assurence', type: 'EMP', code: 'QA' },
];
